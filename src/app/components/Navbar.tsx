                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative ml-3 group">
                        <div className="flex items-center space-x-2 cursor-pointer">
                            ...
                            <div className="hidden md:block">
                                ...
                                <div className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-200">
                                    {user ? user.role : 'Visitor'} {/* Display user role or default to Visitor */}
                                </div>
                            </div>
                        </div>
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity duration-200">
                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600">Your Profile
                            </a>
                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600">Settings</a>
                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600">Sign out</a>
                        </div>
                    </div>
                </div>
            </div>
